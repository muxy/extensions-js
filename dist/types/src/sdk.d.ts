...
import { CallbackHandle, Messenger, ListenCallback } from './messenger';
...
import type { TriviaLeaderboard, TriviaOption, TriviaQuestion, TriviaQuestionResponse, TriviaQuestionState, TriviaStateResponse, TriviaTeam } from './types/trivia';
import type { ExtensionUsersResult } from './types/user';
import type { VoteData, VoteLog } from './types/vote';
declare type ExtensionAnchor = 'component' | 'panel' | 'video_overlay';
declare type ExtensionMode = 'config' | 'dashboard' | 'viewer';
declare type ExtensionPlatform = 'web' | 'mobile';
declare type ExtensionState = 'testing' | 'hosted_test' | 'approved' | 'released' | 'ready_for_review' | 'in_review' | 'pending_action' | 'uploading';
/**
...
export default class SDK {
     ...
     */
    vote(voteID: string, value: number, count?: number): Promise<VoteData>;
    /**
     * User Ranking
     */
    /**
     ...
     * });
     */
    listen<Payload>(inEvent: string, inUserID: string | ListenCallback<Payload>, inCallback?: ListenCallback<Payload>): CallbackHandle;
    /**
     ...
     */
    unlisten(handle: CallbackHandle): void;
    /**
     * Transaction System
     */
    /**
