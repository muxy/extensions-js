...
export default class SDK {
   ...
   */
  public getExtensionState(): Promise<unknown> {
   ...
   */
  public getExtensionViewerState(): Promise<unknown> {
   ...
   */
  public getViewerState(): Promise<unknown> {
   ...
   */
  public getExtensionSecretState(): Promise<unknown> {
